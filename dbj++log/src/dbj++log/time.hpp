...
namespace g3 
{
   ...
   //   constexpr inline auto date_formatted = "%Y/%m/%d"sv ;
	...
	constexpr inline auto time_formatted = "%H:%M:%S %f6"sv ;
    constexpr inline auto date_time_formatted = "%Y/%m/%d %H:%M:%S %f6"sv ;
   } // internal
   ...
   * modify this to use std::strftime instead */
   ...
   inline system_time_point to_system_time(const high_resolution_time_point& ts)
   {
	   ...
	   // dbj: what's the point of the 'const' here?
